...
public:
	...
	*/
	...
	bool	SummonItem(uint32 item_id, int8 quantity = -1, uint16 to_slot = EQ::invslot::slotCursor, bool force_charges = false, const EQ::ItemCustomData* item_custom_data = nullptr);
