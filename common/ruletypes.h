...
RULE_STRING(SelfFound, IdentifyMessageFormat, "Self Found Item: %1$s's %2$s.", "The message printed when a self-found item is identified. Arg1=CharacterName, Arg2=ItemName")
